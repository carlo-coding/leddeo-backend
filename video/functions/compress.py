...
def compress_video(video_full_path, output_file_name):
  stream = ffmpeg.input(video_full_path)
  stream = ffmpeg.output(stream, output_file_name, vcodec='libx264', crf=23)
  ffmpeg.run(stream)
  print("Video successfully compressed:", output_file_name)
